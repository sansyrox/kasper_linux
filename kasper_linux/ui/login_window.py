...
def is_valid(email, password):
    """
    Method to Validate kasper Login Details
    :param email: kasper Sign-in email
    :param password: kasper Sign-in password
    ...
    sign_in_url = 'http://api.kasper.ai/aaa/login.json?type=access-token'
