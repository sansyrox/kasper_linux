...
parser = argparse.ArgumentParser(prog='python3 -m kasper_linux',
                                 description='kasper Linux main program')
...
def startup_sound():
    ...
    audio_file = os.path.join(curr_folder, 'wav/ting-ting_kasper_has_started.wav')
